...
Current recommended public version: [`v2.3.47`](../releases/v2.3.47.md)
...
`VibeSkills v2.3.47` is the current recommended public version. It is not another skill list. It is a governed skills substrate that routes, composes, and verifies skills so general-purpose AI can complete tasks more reliably. Try it first, look around first, and star the repo if the direction resonates.

## Short community version

VibeSkills `v2.3.47` is now the recommended public version.
...
VibeSkills `v2.3.47` is the current outward-facing recommended version.
...
If you want a practical governed AI setup instead of another loose pile of skills, start with `v2.3.47`.
...
- `v2.3.47` is the current recommended governed install surface
